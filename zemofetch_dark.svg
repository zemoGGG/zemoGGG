...
<tspan x="370" y="30">matthew@martin</tspan>
<tspan x="370" y="50">——————</tspan>
<tspan x="370" y="70" class="keyColor">OS</tspan>: <tspan class="valueColor">Arch Linux, Windows 10</tspan>
<tspan x="370" y="90" class="keyColor">Uptime</tspan>: <tspan class="valueColor">21 years</tspan>
<tspan x="370" y="110" class="keyColor">Host</tspan>: <tspan class="valueColor">San Jose State University</tspan><tspan class="commentColor"> #SJSU</tspan>
<tspan x="370" y="130" class="keyColor">Kernel</tspan>: <tspan class="valueColor">Information Science and Data Analytics</tspan><tspan class="commentColor"> #ISDA</tspan>
<tspan x="370" y="150" class="keyColor">IDE</tspan>: <tspan class="valueColor">VSCode, IntelliJ IDEA</tspan>
<tspan x="370" y="190" class="keyColor">Languages</tspan>.<tspan class="keyColor">Programming</tspan>: <tspan class="valueColor">Python, SQL, JavaScript, Java</tspan>
<tspan x="370" y="210" class="keyColor">Languages</tspan>.<tspan class="keyColor">Computer</tspan>: <tspan class="valueColor">HTML, CSS, JSON, Git</tspan>
<tspan x="370" y="230" class="keyColor">Tools</tspan>.<tspan class="keyColor"></tspan>: <tspan class="valueColor">PowerBI, Tableau, Flask, Splunk, Microsoft Office</tspan>
<tspan x="370" y="270" class="keyColor">Hobbies</tspan>.<tspan class="keyColor"></tspan>: <tspan class="valueColor">Cooking, Cybersecurity, Minecraft Modding</tspan>

<tspan x="370" y="330" class="keyColor">Contact</tspan>:
<tspan x="370" y="350">——————</tspan>
<tspan x="370" y="370" class="keyColor">Email</tspan>: <tspan class="valueColor">matthewm.martin7@gmail.com</tspan>
<tspan x="370" y="390" class="keyColor">LinkedIn</tspan>: <tspan class="valueColor">matthew-martin-0b3a63167</tspan>
